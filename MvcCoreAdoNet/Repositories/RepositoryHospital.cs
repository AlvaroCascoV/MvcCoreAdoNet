...
namespace MvcCoreAdoNet.Repositories
{
    public class RepositoryHospital
    {
        ...
        // Se puede hacer con un objeto Hospital como parámetro, pero si hay problemas es mas dificil de depurar
        ...
        public async Task UpdateHospitalesAsync(int idHospital, string nombre, string direccion, string telefono, int camas)
        {
