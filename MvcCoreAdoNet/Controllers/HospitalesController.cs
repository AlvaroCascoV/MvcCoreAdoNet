...
namespace MvcCoreAdoNet.Controllers
{
    public class HospitalesController : Controller
    {
        ...
        public async Task<IActionResult> Create(Hospital hospital)
        {
            ...
            //DESPUES DE CREAR, QUEREMOS VOLVER AL ACTION DEL INDEX
        ...
        {
            await this.repo.UpdateHospitalesAsync(hospital.IdHospital, hospital.Nombre, hospital.Direccion, hospital.Telefono, hospital.Camas);
            ViewData["MENSAJE"] = "Hospital modificado";
            //DESPUES DE MODIFICAR, QUEREMOS VOLVER AL ACTION DEL INDEX
            return RedirectToAction("Index");
        }
